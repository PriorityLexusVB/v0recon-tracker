  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-100 px-4 py-12 dark:bg-gray-900">
      <div className="w-full max-w-md rounded-lg bg-white p-8 text-center shadow-lg dark:bg-gray-800">
        ...
        <h1 className="mt-6 text-3xl font-bold text-gray-900 dark:text-gray-50">Deployment Successful!</h1>
        <p className="mt-4 text-gray-600 dark:text-gray-400">
          Your Recon Tracker application has been successfully deployed.
        </p>
        <p className="mt-2 text-gray-600 dark:text-gray-400">
          You can now access your dashboard and start managing vehicles.
        </p>
