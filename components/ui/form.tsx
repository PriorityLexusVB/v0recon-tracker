...
type FormContext = UseFormReturn

const Form = FormProvider

type FormFieldContextValue<
  TFieldValues extends FormContext["_formValues"] = FormContext["_formValues"],
  TName extends FormContext["_names"] = FormContext["_names"],
> = {
  name: TName
} & Pick<FormContext, "control">
